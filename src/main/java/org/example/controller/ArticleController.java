...
public class ArticleController extends Controller {
    ...
    private void doWrite() {
        ...
        String writer = Controller.loginname;
    ...
    private void doDelete() {
        ...
        if(Controller.loginname.equals(foundArticle.getWriter())==false) {
    ...
    public void makeTestData() {
        ...
        articles.add(new Article(1, "2024-12-12 12:12:12", "2024-12-12 12:12:12", "제목123", "내용1", "작성자1"));
        articles.add(new Article(2, Util.getNowStr(), Util.getNowStr(), "제목27", "내용2", "작성자2"));
        articles.add(new Article(3, Util.getNowStr(), Util.getNowStr(), "제목1233", "내용3", "작성자3"));
    }
}